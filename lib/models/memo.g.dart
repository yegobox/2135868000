...
extension MemoQueryFilter on QueryBuilder<Memo, Memo, QFilterCondition> {
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> memoEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> memoGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> memoLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> memoBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> memoStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> memoEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> memoContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'memo',
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> memoMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'memo',
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> memoIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'memo',
        value: '',
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> memoIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'memo',
        value: '',
...
extension MemoQuerySortBy on QueryBuilder<Memo, Memo, QSortBy> {
  ...
  QueryBuilder<Memo, Memo, QAfterSortBy> sortByMemo() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'memo', Sort.asc);
    });
  }

  QueryBuilder<Memo, Memo, QAfterSortBy> sortByMemoDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MemoQuerySortThenBy on QueryBuilder<Memo, Memo, QSortThenBy> {
  ...
  QueryBuilder<Memo, Memo, QAfterSortBy> thenByMemo() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'memo', Sort.asc);
    });
  }

  QueryBuilder<Memo, Memo, QAfterSortBy> thenByMemoDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'memo', Sort.desc);
    });
  }
...
extension MemoQueryWhereDistinct on QueryBuilder<Memo, Memo, QDistinct> {
  ...
  QueryBuilder<Memo, Memo, QDistinct> distinctByMemo(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MemoQueryProperty on QueryBuilder<Memo, Memo, QQueryProperty> {
  ...
  QueryBuilder<Memo, String, QQueryOperations> memoProperty() {
    return QueryBuilder.apply(this, (query) {
